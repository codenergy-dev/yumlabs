def prompt_pipeline(
  ...
  **kwargs,
  ...
  negative_prompt = ", ".join(negative_prompt for negative_prompt in [style["negative_prompt"], negative_prompt] if negative_prompt is not None)
  return { "prompt": prompt, "negative_prompt": negative_prompt }

# https://github.com/ahgsql/StyleSelectorXL
def get_style(name: str):
  return next((style for style in [
    {
      "name": "3D Model",
